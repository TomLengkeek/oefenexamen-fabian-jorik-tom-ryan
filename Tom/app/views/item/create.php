                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div id="select">
                                ...
                                <input type="date" class="form-control" aria-label="Category" name="aanschaffingsdatum" requirerd>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <label class="form-label">Typenummer</label>
                            <input type="number" name="typenummer" step="1" class="form-control" required>
                        </div>
                    </div>
